...
-(void)startMarqueeViewAnimation{
    ...
    // 1.设置滚动前的数据
   // self.customView1.titleLabel.attributedText = self.marqueeTitleArray[currentIndex];
   ...
   // self.customView2.titleLabel.attributedText = self.marqueeTitleArray[currentIndex];
    self.customView2.contentLabel.attributedText = self.marqueeContentArray[currentIndex];
    self.customView2.frame = CGRectMake(0, self.frame.size.height, self.frame.size.width, self.frame.size.height);
