...
- (void)setupView {
    ...
    self.titleLabel.frame   = CGRectMake(10, 10, 0, 0);
    self.contentLabel.frame = CGRectMake(CGRectGetMaxX(self.titleLabel.frame), CGRectGetMinY(self.titleLabel.frame), SCREEN_WIDTH-89-14, 20);
}
@end
