...
typedef NS_ENUM(NSUInteger, ZQPlayerState) {
    ZQPlayerStateReadyToPlay, // 播放器准备完毕 0
    ZQPlayerStatePlaying, // 正在播放 1
    ZQPlayerStatePause, // 暂停 2
    ZQPlayerStateStop, // 播放完毕 3
    ZQPlayerStateBufferEmpty, // 缓冲中 4
    ZQPlayerStateKeepUp, // 缓冲完成  5
    ZQPlayerStateFailed, // 播放器准备失败、网络原因，格式原因  6
};
